...
from binance_ingestor.api.exceptions import BinanceWebsocketUnableToConnect
from binance_ingestor.utils import get_loop, get_logger
...
class ReconnectingWebsocket:
    ...
    def _create_connection_kwargs(self):
        ...
        if self._proxy:
            ...
            if proxy_parsed.scheme in ('http', 'https', 'socks5'):
    ...
    async def connect(self):
        ...
        self._conn = ws.connect(ws_url, **connection_kwargs)
