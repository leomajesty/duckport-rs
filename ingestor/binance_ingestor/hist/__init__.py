"""
Hist package — Binance historical data downloading and Parquet conversion.
"""

from binance_ingestor.config import (
    RESOURCE_PATH, CONCURRENCY, BASE_URL, root_center_url,
    SETTLED_USDT_PERP_SYMBOLS, SETTLED_USDT_SPOT_SYMBOLS,
    proxy, use_proxy_download_file,
    retry_times, thunder, START_MONTH,
    need_analyse_set, daily_updated_set,
